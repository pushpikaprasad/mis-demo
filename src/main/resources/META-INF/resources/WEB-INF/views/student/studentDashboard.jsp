...
<body ng-controller="StudentPageData">
	...
	<div id="left-side">
		<ul id="slide-out" class="sidenav sidenav-fixed z-depth-4">
			...
			<li class="nav-item active  "><a class="nav-link"
				href="/studentDashboard"> <i class="material-icons">dashboard</i>
					<p>Dashboard</p>
			</a></li>
			<li class="nav-item "><a class="nav-link"
				href="/studentDashboard/myAccount"> <i class="material-icons">person</i>
					<p>My Account</p>
			</a></li>
			<!-- <li class="nav-item "><a class="nav-link"
		...
		<div class="row">
			<div class="col s12 m6 l4">
				<div class="card cardHover">
					<a href="#applications"
						class="btn_load_application black-text modal-trigger">
	...
	<div id="applications" class="modal">
		<div class="modal-content">
			...
			<div class="row">
				<div class="col s12">
					<ul class="tabs">
						<li class="tab col s3"><a class="active" href="#one">TRANSCRIPT/ACADEMIC
								RANK</a></li>
				...
				<div id="one" class="col s12">
					<form id="form" enctype="multipart/form-data">
							...
							<div class="col s12 m12 l12 #e8f5e9 green lighten-5">
								...
								<div id="emailTo" style="display:none;"><div class="input-field col s12 m12 l12">Email To: <b>${email}</b></div></div>
...
.submit( function( e ) {
  $.ajax( {
    url: '/studentDashboard/Application/sendApplication',
	type : 'POST',
