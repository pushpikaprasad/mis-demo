...
<body ng-controller="officerPageData" id="pageBody">
	...
	<ul id="slide-out" class="sidenav sidenav-fixed z-depth-4">
		...
		<li class="nav-item active  "><a class="dashboard_link nav-link" href="/officerDashboard">
				<i class="material-icons">dashboard</i>
				<p>Dashboard</p>
		</a></li>
		<li class="nav-item "><a class="nav-link" href="/officerDashboard/myAccount">
								...
								<form >	
									...
									<div class="modal-footer">
										<button class="btn waves-effect waves-light modal-close"
											...
											ng-click="updateOfficer(firstName,lastName,nic,address,email,mobileNumber)">
